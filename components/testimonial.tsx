...
const testimonials = [
  {
    ...
    testimonial:
      "Tech Innovators has revolutionized our business operations with their cutting-edge solutions. Their team is highly skilled and dedicated to delivering exceptional results.",
  ...
  },
  {
    ...
    testimonial:
      "Working with Creative Solutions has been a game-changer for our marketing strategy. Their innovative approach and creative insights have significantly boosted our brand visibility.",
  ...
  },
  {
    ...
    testimonial:
      "NextGen Tech's products are top-notch and have greatly enhanced our product offerings. Their customer service is outstanding, and they truly care about their clients.",
  ...
  },
  {
    ...
    testimonial:
      "Logistics Pro has streamlined our supply chain processes, making them more efficient and cost-effective. Their expertise in logistics is unparalleled.",
  ...
  },
  {
    ...
    testimonial:
      "People First has transformed our HR practices, making them more employee-centric and effective. Their team is knowledgeable and always ready to assist.",
    avatar: "/testimonials/client5.jpg",
  },
  {
    id: 6,
    name: "James Wilson",
    ...
    testimonial:
      "Smart Finance has provided us with invaluable financial insights that have helped us optimize our budget and increase profitability.",
    avatar: "/testimonials/client6.jpg",
  },
];
const Testimonial = () => {
      ...
      <div className="flex flex-col justify-center">
        <div className="flex items-center justify-between gap-1">
          ...
          <div className="flex items-center gap-1">
            <StarIcon className="w-5 h-5 fill-[#DDC182] stroke-[#DDC182]" />
            <StarIcon className="w-5 h-5 fill-[#DDC182] stroke-[#DDC182]" />
            <StarIcon className="w-5 h-5 fill-[#DDC182] stroke-[#DDC182]" />
            <StarIcon className="w-5 h-5 fill-[#DDC182] stroke-[#DDC182]" />
            <StarIcon className="w-5 h-5 fill-[#DDC182] stroke-[#DDC182]" />
